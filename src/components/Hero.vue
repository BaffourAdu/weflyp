<template>
    <header class="h-full">
        ...
        <div class="bg-white sm:py-20 py-8 xl:px-64 md:px-8 px-6 bottom-header text-center" style="height: 60vh;">
            ...
            <p class="md:text-xl text-lg py-4 leading-snug mb-4 tracking-wide text-gray-700">WeFlyp provides you with all the Tools & Support you need to start and run a business <br class="lg:block hidden">
